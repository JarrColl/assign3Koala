...
class DeliveryPage(Page):
    ...
    def print_deliveries(deliveries):
        ...
        for delivery in deliveries:
            print("| {:<5} | {:<20} | {:<10} |".format(delivery['id'], delivery['description'], delivery['status']))
    ...
    def mark_delivery():
        ...
        delivery_index = OptionSelection.show(delivery_list, "Select a Delivery to mark as delivered", "Return to home.")
