...
class KitchenPage(Page):
    ...
    def display(login_manager):
        ...
        paid_orders = [order for order in order_dict if (order['status'] == 'Paid' or order['status']=='Cooking')]
                ...
                if user_input == "q":
                    ...
                    for order in order_list:
                        if str(order.getId()) == order_id_to_update:
                            ...
                            KitchenPage.update_order_status(order_id_to_update,new_status)
                    ...
                    if not founded:
                        KitchenPage.clear_screen()
                        print("!!!!Invalid order ID, please enter 'u' to update order status again!!!!")
                else:
                    KitchenPage.clear_screen()
                    print("!!!!Invalid input, please enter 'q' to exit or 'u' to update order status.!!!!")
